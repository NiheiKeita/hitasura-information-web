...
const articles = [
    ...
    },
    {
        ...
        subtitle: '情報学としての反復の考え方を整理',
        description:
            'ループの意味、必要性、条件分岐との関係、終了条件の重要性までを情報学の視点で解説。',
        href: '/articles/loop',
        badge: '基礎理解',
        readTime: '読む目安: 8分',
        keywords: ['ループ', '繰り返し処理', '条件分岐', '情報学', '反復'],
    },
    {
        title: '2進数とは？情報学で「0と1」を使う理由を基礎から完全解説',
        subtitle: '0と1で表す仕組みを情報学の視点で整理',
        description:
            '2進数の意味、10進数との違い、なぜ2進数なのか、情報量やビットとの関係までをやさしく解説。',
        href: '/articles/binary',
        badge: '基礎理解',
        readTime: '読む目安: 9分',
        keywords: ['2進数', 'ビット', '情報量', 'データ表現', '情報学'],
    },
    {
